...
![Figure 2: PCA projection of the latent trajectory.](figures/fig2_latent_pca.png)
...
![Figure 3: Encoder Jacobian over time.](figures/fig3_jacobian.png)
...
![Figure 4: Symbol segmentation in latent space.](figures/fig4_symbol_clusters.png)
...
![Figure 5: Symbolic state-transition graph derived from the clustered latent sequence.](figures/fig5_state_machine.png)
...
![Figure 6a: Flow latent segmentation.](figures/fig6a_flow_latent_segmentation.png)

![Figure 6b: Flow Jacobian time series.](figures/fig6b_flow_jacobian_timeseries.png)

![Figure 6c: Latent structure comparison.](figures/fig6c_latent_structure_comparison.png)
...
![Figure 7: Diffusion vs. real latent trajectory.](figures/fig7_diffusion_vs_real.png)
...
![Figure 8: Cross-model segmentation summary.](figures/fig8_segmentation_overlay.png)
